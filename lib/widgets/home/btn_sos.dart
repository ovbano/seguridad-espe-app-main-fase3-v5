        ...
        return Positioned(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment
                .spaceBetween, // Alinea los widgets a ambos extremos
            children: [
              // Widget del icono de notificaciones
              GestureDetector(
                onTap: () {
                ...
                child: Padding(
                  padding: const EdgeInsets.only(
                      right: 157, top: 20), // Ajusta el padding como necesario
                  child: Stack(
                    children: [
                      Container(
                        width: 65,
              ...
              // Widget del botón SOS
              Padding(
                padding: const EdgeInsets.only(
                    right: 8, top: 20), // Ajusta el padding como necesario
